 ...
 *     server/edge (именно оттуда прилетал инцидент). Инструкция оператору по ручному запуску
 *     standalone с SENTRY_DISABLED=1 — в README.md («Запуск standalone-сборки локально»).
 *
