...
export default function SchoolsPage() {
  ...
  const tsc = useTranslations('partners.schools');
  ...
  return (
    <Box sx={{ overflow: 'hidden' }}>
      ...
      >
        ...
        {/* Name */}
        <Field label={tsc('fieldName')} required>
