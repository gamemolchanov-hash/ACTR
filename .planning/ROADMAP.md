...
- [x] **Phase 4: i18n EN/TR** - вынос строк, переключатель, локализация контента, SEO (completed 2026-06-30)
- [x] **Phase 5: Комплаенс-UI** - KDV, согласия KVKK/«mesafeli satış», юр-страницы (completed 2026-06-30)
- [x] **Phase 6: Чистка OMS-специфики + бренд TR** - удалить BOGO/отзывы/CDEK/PayKeeper, свопы бренда (executed 2026-07-01, 5/5 plans; verification gaps_found — RU legal identity on /contacts + footer domain; run /gsd-plan-phase 6 --gaps) (completed 2026-07-01)
- [x] **Phase 7: Каталог-данные TR** - TRY-витрина+дистрибьютор с товарами AC (completed 2026-07-01)
...
- [x] 04-03-PLAN.md — Auth/account: login×4 + account×5 строки (checkout/basket подтвердить) — wave 3, depends 04-02 (I18N-01)
- [x] 04-04-PLAN.md — Статика: studios/delivery/contacts/faq + partners×4 + error-страницы — wave 4, depends 04-03 (I18N-01)
- [x] 04-05-PLAN.md — SEO: hreflang/OG/sitemap + seo.ts(TRY) + серверный ?lang + Tolgee finalize + фазовый gate — wave 5, depends 04-04 (I18N-01, I18N-04)
...
**Plans**: 3 plans (planned 2026-06-30)

Plans:

- [x] 05-01-PLAN.md — Legal stub pages (5) + footer links — wave 1 (COMP-02)
- [x] 05-02-PLAN.md — KDV display: kdvFromBrutto + «KDV Dahil» labels + KDV line — wave 2, depends 05-01 (COMP-01)
- [x] 05-03-PLAN.md — Consent gate: KVKK + mesafeli checkboxes in checkout — wave 3, depends 05-01,05-02 (COMP-02)
...
- [x] 06-01-PLAN.md — Remove dead BOGO auto-promo (module+consumers+assets+i18n) — wave 1 (CLEAN-01, D-08)
...
- [x] 06-03-PLAN.md — Delete partners/studios routes+nav+sitemap + prune Bitrix redirects — wave 3, depends 06-02 (CLEAN-01, D-01, D-07)
...
- [x] 06-06-PLAN.md — Close Gap 1 (contacts legal block → TR [Placeholder] disclosure) + Gap 2 (footer copyright → dynamic-year neutral brand line) — wave 1, depends none (CLEAN-01, CLEAN-02)
...
- [x] 07-01-PLAN.md — Emit X-Currency on all catalog paths (SSR bffGet + client fetchProducts/fetchCategories + proxy regression guard); fix stale OMS docstring (DATA-01 code slice)
...
| 7. Каталог-данные TR | 1/1 | Complete   | 2026-07-01 |
