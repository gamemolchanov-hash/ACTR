...
- [ ] **Phase 3: Авторизация и личный кабинет** - register/login/ЛК на ARM, GDPR/KVKK (executed 2026-06-30 — verification human_needed, 5 UAT pending)
...
| 3. Авторизация и ЛК | 3/3 | Executed — UAT pending | 2026-06-30 |
