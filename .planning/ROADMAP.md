...
- [ ] **Phase 1: Каталог на ARM** - переключить data-layer на ARM, адаптер каталога, рендер из ARM
...
Plans:
- [ ] 01-01: TBD (определится в `/gsd-plan-phase 1`)
...
|-------|----------------|--------|-----------|
| 1. Каталог на ARM | 0/TBD | Not started | - |
| 2. Корзина и чекаут | 0/TBD | Not started | - |
