...
- [ ] **Phase 6: Чистка OMS-специфики + бренд TR** - удалить BOGO/отзывы/CDEK/PayKeeper, свопы бренда (executed 2026-07-01, 5/5 plans; verification gaps_found — RU legal identity on /contacts + footer domain; run /gsd-plan-phase 6 --gaps)
...
| 6. Чистка + бренд TR | 5/5 | Complete   | 2026-07-01 |
